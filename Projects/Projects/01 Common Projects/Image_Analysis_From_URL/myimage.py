...
st.set_page_config(page_title="Prakash senapati Image Processor", layout="wide")

# Title
st.title("Prakash senapati Image - Multi-Color Channel Visualizer")

# Load image from local path
@st.cache_data
def load_image():
    path = r"C:\Users\Admin\AVSCODE\NumpyProject\myimage.jpg"
